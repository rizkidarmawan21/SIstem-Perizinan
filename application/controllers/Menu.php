...
class Menu extends CI_Controller {
    ...
    public function getMenuById($id_menu){
            ...
            $data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
            $data['menu'] = $this->db->get_where('user_menu',$id)->row_array();
            $this->load->view('templates/header',$data);
            $this->load->view('templates/sidebar',$data);
            $this->load->view('templates/topbar',$data);
            $this->load->view('menu/changemenu',$data);
            $this->load->view('templates/footer',$data);
    }
    ...
    public function getSubMenuById($id_submenu){
        ...
        $data['submenu'] = $this->db->get_where('user_sub_menu',$id)->row_array();
        // $this->load->model('Menu_model','menu');
        // $data['subMenu'] = $this->menu->getSubMenuById($id_submenu);
        $data['menu'] = $this->db->get('user_menu')->result_array();
        $this->load->view('templates/header',$data);
        $this->load->view('templates/sidebar',$data);
        $this->load->view('templates/topbar',$data);
