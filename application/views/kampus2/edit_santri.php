...
<h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
    ...
    <div class="row">
        <div class="col-lg-7">
            ...
            <form action="<?= base_url('kampus_2/editSantri_aksi')?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <option value="Imam Syafii"> Imam Syafii </option>
                        <option value="Imam Bukhori"> Imam Bukhori </option>
                        <option value="Imam Muslim"> Imam Muslim </option>
                        <option value="Ibnu Anfas"> Ibnu Anfas </option>
                        <option value="Imam Tobari"> Imam Tobari </option>
                        </select>
