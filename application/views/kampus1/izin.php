                ...
                <div class="col-md-6">
                        <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-user" placeholder="<?= date('d/m/Y')?>" value="" readonly >
                        ...
                        <div class="form-group" id="jam" hidden>
                                <div class="row">
                                    ...
                                    <input type="time" class="form-control form-control-user" id="jam_keluar" name="jam_keluar" value="<?= date('H:i')?>" readonly>
                                    <?= form_error('jam_keluar','<small class="text-danger pl-3 ">','</small>'); ?>
                                    </div>
                                    <div class="col-md-6">
                                    <label for="jam_kembali_keluar">Waktu Kembali</label>
                                    <input type="time" class="form-control form-control-user" id="jam_kembali_keluar" name="jam_kembali_keluar">
