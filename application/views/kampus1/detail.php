    ...
    <hr class="sidebar-divider mt-3">
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                        ...
                        <?php
                        if ($santri['izin'] == 'Keluar') :
                        ?>
                        <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                    <label for="jam_keluar">Waktu Keluar</label>
                                    <input type="text" id="jam_keluar" name="jam_keluar" class="form-control" value="<?= date('H:i ',$santri['jam_keluar']) ?>" readonly>
                                    </div>
                                    <div class="col-md-6">
                                    <label for="jam_kembali_keluar">Waktu Kembali</label>
                                    <input type="text" id="jam_kembali_keluar" name="jam_kembali_keluar" class="form-control" value="<?= $santri['jam_kembali_keluar']?>" readonly>
                                    </div>
                                </div>
                        </div>
                    <?php endif?>
