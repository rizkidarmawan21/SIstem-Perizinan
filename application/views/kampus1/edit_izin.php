    ...
    <hr class="sidebar-divider mt-3">
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                        <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="" name=""  value="<?= date('d/m/Y', $santri['tgl_ijin']) ?>" readonly >
                        ...
                        <?php if($santri['izin'] == 'Keluar') :?>
                            <div class="form-group" id="jam">
                                <div class="row">
                                    <div class="col-md-6">
                                    <label for="jam_keluar">Waktu Keluar (Otomatis)</label>
                                    <input type="text" class="form-control form-control-user" value="<?= date('H:i',$santri['jam_keluar'])?>" id="jam_keluar" name="jam_keluar" readonly>
                                    <?= form_error('jam_keluar','<small class="text-danger pl-3 ">','</small>'); ?>
                                    </div>
                                    <div class="col-md-6">
                                    <label for="jam_kembali_keluar">Waktu Kembali</label>
                                    <input type="time" class="form-control form-control-user" id="jam_kembali_keluar" value="<?= $santri['jam_kembali_keluar']?>" name="jam_kembali_keluar">
                                    <?= form_error('jam_kembali_keluar','<small class="text-danger pl-3 ">','</small>'); ?>
                                    </div>
                                </div>
                        </div>
                            <?php else :?>
                                <div class="form-group" id="jam" hidden>
                                <div class="row">
                                    <div class="col-md-6">
                                    <label for="jam_keluar">Waktu Keluar (Otomatis)</label>
                                    <input type="text" class="form-control form-control-user" value="<?= date('H:i',$santri['jam_keluar'])?>" id="jam_keluar" name="jam_keluar" readonly>
